...
public class Neo4jUtility {
	...
	static Path getImportFolderPath(String database) {
    	var importQuery = "Call dbms.listConfig() YIELD name, value WHERE name contains 'directories.import' RETURN value";
    	var homeQuery = "Call dbms.listConfig() YIELD name, value WHERE name contains 'directories.neo4j_home' RETURN value";
